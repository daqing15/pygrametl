...
def datereader(dateattribute, parsingfunction=ymdparser):
    """Return a function that converts a certain dict member to a Date.
    ...
    def readerfunction(targetconnection, row, namemapping = {}):
        ...
        thedate = parsingfunction(row[atttouse]) # a datetime.date
        modref = targetconnection.getunderlyingmodule()
...
def datetimereader(datetimeattribute, parsingfunction=ymdhmsparser):
    """Return a function that converts a certain dict member to a Timestamp.
    ...
    def readerfunction(targetconnection, row, namemapping = {}):
        ...
        thedt = parsingfunction(row[atttouse]) # a datetime.datetime
        modref = targetconnection.getunderlyingmodule()
